    ...
    return (
        <div className="about-container">
            <div className="about-description-container about-contnent">
                ...
                <p>Driven by the goal of improving human's lives through my knowledge and skills<span className="red">,</span> I am committed to life long learning and hard work to build a better future<span className="red">.</span></p>
            </div>
